...
extension SegueManager {
  ...
  public func performSegue<Segue: UIStoryboardSegue, Source : UIViewController, Destination: UIViewController>(segueIdentifier: StoryboardSegueIdentifier<Segue, Source, Destination>, handler: TypedStoryboardSegueInfo<Segue, Source, Destination> -> Void) {
